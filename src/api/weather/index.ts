...
const getSign = (location: string, PRIVATE_KEY: string, ts: number) => {
...
export const getActualWeather = (location: string, PRIVATE_KEY: string, ts: number) => {
    const {otherParams, SIG} = getSign(location, PRIVATE_KEY, ts)
    return serviceAxios({
...
export const getRecentWeather = (location: string, PRIVATE_KEY: string, ts: number) => {
    const {otherParams, SIG} = getSign(location, PRIVATE_KEY, ts)
    return serviceAxios({
